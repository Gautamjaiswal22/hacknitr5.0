                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        ...
                        String ownership = hospitals[index]["general_data"]
                                ["ownership"] ??
                            "Unknown Hospital";
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => detailhosp(
                            hname: hospitals[index]["general_data"]
                                    ["hospitalName"] ??
                                "Unknown Hospital",
                            hid: hid,
                            ownership: hospitals[index]["general_data"]
                                    ["ownership"] ??
                                "Unknown Hospital",
                            staffsize: hospitals[index]["general_data"]
                                    ["staffSize"] ??
                                "0",
                            festures:
                                hospitals[index]["general_data"]["features"] ??
                                    "features"
                                        "0",
                            address1: hospitals[index]["address_data"]
                                    ["address1"] ??
                                "Unknown address",
                            address2: hospitals[index]["address_data"]
                                    ["address2"] ??
                                "Unknown address",
                            address3: hospitals[index]["address_data"]
                                    ["address3"] ??
                                "Unknown address",
                            city: hospitals[index]["general_data"]["city"] ??
                                "unknown city",
                            state: hospitals[index]["general_data"]["state"] ??
                                "Unknown state",
                            email: hospitals[index]["contact_data"]["mail"] ??
                                "Unknown email",
                            mobile: hospitals[index]["contact_data"]
                                    ["mobile"] ??
                                "no phone",
                            dbid: hospitals[index]["_id"],
                          ),
                        ));
                      },
                      child: Container(
